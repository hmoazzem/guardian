...
@Component({
  selector: 'e-cpu-clock',
  imports: [CommonModule, NgxEchartsDirective],
  template: `
    <div *ngIf="isChartReady" echarts [options]="chartOptions" [merge]="updateOptions" class="cpu_clock"
...
export class CpuClockComponent implements OnInit, OnDestroy {
  ...
  private initializeChart(initialData: Number[]): void {
    ...
    this.chartOptions = {
      title: {
        text: `CPU Clock Speeds (${this.numberOfCores} vCPU)`,
        left: 'center'
      },
      tooltip: {
        trigger: 'axis',
